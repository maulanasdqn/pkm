...
export const Sidebar: FC<TSidebarProps> = ({
  ...
  return (
    <aside className="sticky left-0 top-[5rem] max-w-[18rem] w-full h-[88dvh] flex flex-col justify-between gap-14 py-10 px-5 shadow-sm border-r border-primary-20%">
